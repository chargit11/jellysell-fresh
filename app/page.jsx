      ...
      <section className="py-12 bg-gray-50 border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            ...
            <img src="https://brandlogos.net/wp-content/uploads/2022/09/depop-logo_brandlogos.net_thf10.png" alt="Depop" className="h-10" />
            <img src="https://brandlogos.net/wp-content/uploads/2022/07/mercari-logo.png" alt="Mercari" className="h-10" />
          </div>
        </div>
      </section>
