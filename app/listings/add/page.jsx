...
export default function AddListingPage() {
  ...
  function handleSave(e) {
    e.preventDefault();
    // TODO: Persist new product; after saving, go back to listings
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1">
        <div className="px-8 py-6 border-b border-gray-200 flex items-center gap-4">
          <Link href="/listings" className="px-3 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-white">
            Back
          </Link>
          <h1 className="text-xl font-semibold text-gray-900">Add Product</h1>
          <div className="ml-auto flex items-center gap-3">
            <Link href="/listings" className="px-4 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-white">
              Cancel
            </Link>
            <button onClick={handleSave} className="px-5 py-2 rounded-lg bg-purple-600 text-white font-semibold hover:bg-purple-700">
              Save Product
            </button>
          </div>
        </div>
