    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-4 flex items-center gap-6">
          <h1 className="text-2xl font-bold text-gray-900 flex-shrink-0">Messages</h1>
          ...
          <div className="flex-1 max-w-2xl">
            <div className="relative">
              <input
                ...
                className="w-full px-6 py-3 pr-12 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-base"
              />
          ...
          <button className="flex items-center gap-2 px-6 py-3 bg-white border border-gray-300 rounded-full font-semibold text-gray-700 hover:bg-gray-50 transition-colors flex-shrink-0">
            Auto-reply
